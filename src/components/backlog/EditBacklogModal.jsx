...
const onSubmit = async (e) => {
  ...
  if (![1, 2, 3].includes(Number(formData.priority))) {
    setLocalError('La prioridad debe ser 1 (Alta), 2 (Media) o 3 (Baja).');
    return;
  }
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-md bg-[#0D0D0D]/30">
        ...
        >
          ...
          <h2 className="text-xl font-bold mb-4 text-center">Editar item</h2>
